...
const token = "5989086587:AAHUMutwesILe78GbWEdxWNXcD1tR0GokE8";
...
bot.on("message", async (msg) => {
  ...
  if (messageText.startsWith("/create")) {
    ...
    const commands = ["/create - Membuat data baru", "/read - Membaca data", "/update - Memperbarui data", "/delete - Menghapus data", "/baca - Membaca data berdasarkan nama barang"];
